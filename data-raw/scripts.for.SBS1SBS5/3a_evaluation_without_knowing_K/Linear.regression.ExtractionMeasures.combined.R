...
{
pdf("../TrendDiag/ExtrAttr/cosSimSBS1AgainstRsq.pdf",12,10)
  ggVsRsq$SBS1 <- ggVsRsq$SBS1 + ggplot2::labs(y = "Cosine similarity to SBS1")
plot(ggVsRsq$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttr/cosSimSBS5AgainstRsq.pdf",12,10)
ggVsRsq$SBS5 <- ggVsRsq$SBS5 + ggplot2::labs(y = "Cosine similarity to SBS5")
plot(ggVsRsq$SBS5)
dev.off()

pdf("../TrendDiag/ExtrAttr/TPRAgainstRsq.pdf",12,10)
ggVsRsq$TPR <- ggVsRsq$TPR + ggplot2::labs(y = "True Positive Rate")
plot(ggVsRsq$TPR)
dev.off()

pdf("../TrendDiag/ExtrAttr/FDRAgainstRsq.pdf",12,10)
...
{
pdf("../TrendDiag/ExtrAttr/cosSimSBS1AgainstSBS1SBS5Ratio.pdf",12,10)
  ggVsRatio$SBS1 <- ggVsRatio$SBS1 + ggplot2::labs(y = "Cosine similarity to SBS1")
plot(ggVsRatio$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttr/cosSimSBS5AgainstSBS1SBS5Ratio.pdf",12,10)
ggVsRatio$SBS5 <- ggVsRatio$SBS5 + ggplot2::labs(y = "Cosine similarity to SBS5")
plot(ggVsRatio$SBS5)
dev.off()

pdf("../TrendDiag/ExtrAttr/TPRAgainstSBS1SBS5Ratio.pdf",12,10)
ggVsRatio$TPR <- ggVsRatio$TPR + ggplot2::labs(y = "True Positive Rate")
plot(ggVsRatio$TPR)
dev.off()

pdf("../TrendDiag/ExtrAttr/FDRAgainstSBS1SBS5Ratio.pdf",12,10)
...
{
  pdf("../TrendDiag/ExtrAttr/cosSimCombined.SBS1.pdf", width = 15, height = 8)
...
{
  pdf("../TrendDiag/ExtrAttr/cosSimCombined.SBS5.pdf", width = 15, height = 8)
  ggObj <- ggpubr::ggarrange(
...
{
  pdf("../TrendDiag/ExtrAttr/TPRFDRCombined.pdf", width = 15, height = 15)
  ggObj <- ggpubr::ggarrange(
