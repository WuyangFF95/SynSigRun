...
{
  pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanCombined.SBS1.pdf", width = 15, height = 8)
...
{
  pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanCombined.SBS5.pdf", width = 15, height = 8)
  ggObj <- ggpubr::ggarrange(
