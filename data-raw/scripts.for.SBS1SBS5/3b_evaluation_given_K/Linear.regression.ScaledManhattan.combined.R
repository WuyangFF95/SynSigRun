...
{
pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanSBS1AgainstRsq.pdf")
  ggVsRsq$SBS1 <- ggVsRsq$SBS1 + ggplot2::labs(y = "Scaled Manhattan distance of SBS1")
plot(ggVsRsq$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanSBS5AgainstRsq.pdf")
...
{
pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanSBS1AgainstSBS1SBS5Ratio.pdf")
  ggVsRatio$SBS1 <- ggVsRatio$SBS1 + ggplot2::labs(y = "Scaled Manhattan distance of SBS1")
plot(ggVsRatio$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanSBS5AgainstSBS1SBS5Ratio.pdf")
...
{
  pdf("../TrendDiag/ExtrAttrExact/ScaledManhattanCombined.pdf", width = 10, height = 10)
