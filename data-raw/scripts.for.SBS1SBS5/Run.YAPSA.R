...
for(seedInUse in seedsInUse){
  for(datasetName in datasetNames){
    RunYAPSAAttributeOnly(input.catalog = paste0(datasetName,"/sp.sp/ground.truth.syn.catalog.csv"),
                          gt.sigs.file = paste0(datasetName,"/sp.sp/ground.truth.syn.sigs.csv"),
                          read.catalog.function = ICAMS::ReadCatalog,
                          out.dir = paste0(datasetName,"/sp.sp/Attr/YAPSA.results/seed.",seedInUse),
