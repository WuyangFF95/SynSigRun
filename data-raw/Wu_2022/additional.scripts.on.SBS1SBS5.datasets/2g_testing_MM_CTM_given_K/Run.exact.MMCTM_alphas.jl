...
for alpha in alphas
    for seedInUse in seedsInUse
        for datasetName in datasetNames
            ...
            snv_counts = CSV.read(datasetName*"/sp.sp/ExtrAttrExactMMCTMTest/MMCTM.alpha."*string(alpha)*".results/seed."*
            ...
            CSV.write(datasetName*"/sp.sp/ExtrAttrExactMMCTMTest/MMCTM.alpha."*string(alpha)*".results/seed."*
