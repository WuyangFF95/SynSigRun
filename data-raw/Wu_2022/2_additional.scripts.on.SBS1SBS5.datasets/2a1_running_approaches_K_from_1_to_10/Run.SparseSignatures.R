...
## Enable stronger parallel computation power.
install.extras("NMF")
...
for(seedInUse in seedsInUse){
  for(datasetName in datasetNames){
    ...
    RunSparseSignatures(input.catalog = paste0(datasetName,"/sp.sp/ground.truth.syn.catalog.csv"),
              out.dir = paste0(datasetName,"/sp.sp/ExtrAttrFromOne/SparseSignatures.results/seed.",seedInUse),
