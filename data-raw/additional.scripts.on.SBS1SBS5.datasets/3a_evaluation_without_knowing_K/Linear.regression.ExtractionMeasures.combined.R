...
{
pdf("../TrendDiag/ExtrAttr/cosSimSBS1AgainstRsq.pdf",10,8)
  ggVsRsq$SBS1 <- ggVsRsq$SBS1 + ggplot2::labs(y = "Cosine similarity to SBS1")
plot(ggVsRsq$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttr/cosSimSBS5AgainstRsq.pdf",10,8)
ggVsRsq$SBS5 <- ggVsRsq$SBS5 + ggplot2::labs(y = "Cosine similarity to SBS5")
plot(ggVsRsq$SBS5)
dev.off()

pdf("../TrendDiag/ExtrAttr/TPRAgainstRsq.pdf",10,8)
ggVsRsq$TPR <- ggVsRsq$TPR + ggplot2::labs(y = "True Positive Rate")
plot(ggVsRsq$TPR)
dev.off()

pdf("../TrendDiag/ExtrAttr/PPVAgainstRsq.pdf",10,8)
...
{
pdf("../TrendDiag/ExtrAttr/cosSimSBS1AgainstSBS1SBS5Ratio.pdf",10,8)
  ggVsRatio$SBS1 <- ggVsRatio$SBS1 + ggplot2::labs(y = "Cosine similarity to SBS1")
plot(ggVsRatio$SBS1)
dev.off()

pdf("../TrendDiag/ExtrAttr/cosSimSBS5AgainstSBS1SBS5Ratio.pdf",10,8)
ggVsRatio$SBS5 <- ggVsRatio$SBS5 + ggplot2::labs(y = "Cosine similarity to SBS5")
plot(ggVsRatio$SBS5)
dev.off()

pdf("../TrendDiag/ExtrAttr/TPRAgainstSBS1SBS5Ratio.pdf",10,8)
ggVsRatio$TPR <- ggVsRatio$TPR + ggplot2::labs(y = "True Positive Rate")
plot(ggVsRatio$TPR)
dev.off()

pdf("../TrendDiag/ExtrAttr/PPVAgainstSBS1SBS5Ratio.pdf",10,8)
