#' \code{SynSigRun}: An easy-to-use package for non-experts which runs software
...
#'
#' @details ## Input mutational spectra
...
#'
#' @details ### Importing mutational spectra from \code{ICAMS}
#'
...
#'
#' @details ### (In \code{SynSigGen}) Creating Synthetic Mutational Spectra
#'
...
#'
#' @details ## (In \code{SynSigRun}) Run mutational analysis computational approaches
#'
#' Relevant functions are: \enumerate{
#'
...
#' }
#'
#' @details ## (In \code{SynSigEval}) Summarize results
#'
